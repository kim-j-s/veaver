(function ($) {
    ...
    const baseHtml = '<div class="cv-inner">'
        ...
        + '<button type="button" class="cv-btn-play"></button>'
        + '<button type="button" class="cv-btn-pause"></button>'
        + '<button type="button" class="cv-btn-close"></button>'
        + '<button type="button" class="cv-btn-fullscreen"></button>'
        + '<button type="button" class="cv-btn-exitfullscreen"></button>'
        + '<button type="button" class="cv-btn-back"></button>'
        + '<button type="button" class="cv-btn-forward"></button>'
        + '</div>'
